...
const firebaseSubscribeToNewsLetter = async (email) => {
  console.log("email", email);
  await addDoc(collection(firebaseDb, "subscriber"), {
    email: email
  })
}

const firebaseAddCollection = async (data) => {
  console.log("data", data);
  await addDoc(collection(firebaseDb, "contactus"), {
...
export {
  ...
  firebaseSubscribeToNewsLetter,
  firebaseAddCollection
}
